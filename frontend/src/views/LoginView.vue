<template>
    <v-app>
      <v-container class="mt-16" align="center">
        <h1 class="mt-16 heading">Welcome Back!</h1>
          <v-sheet :width="smAndUp? '500' : '330'" class="mt-5 pa-6 pb-3" elevation="4" rounded="lg">
          <v-form>
          <v-text-field label="Username" color="primary" prepend-inner-icon="$account" required></v-text-field>
          ...
          color="primary" @click:append-inner="showPassword = !showPassword" required></v-text-field>
